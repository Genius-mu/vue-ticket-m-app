<template>
  <section class="px-6 py-10 min-h-screen bg-gradient-to-b from-blue-50 to-blue-100">
    <div class="flex justify-between items-center mb-6">
      <h1 class="xl:text-3xl md:text-3xl sm:text-3xl text-[17px] font-bold text-blue-700">Ticket Dashboard</h1>
    ...
    <!-- Summary Cards -->
    <div class="grid sm:grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-6 ">
    ...
    <RouterLink
      to="/tickets"
      class="bg-blue-600 w-full flex justify-center sm:w-fit hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium shadow-md"
    >
      Go to Tickets Page →
    </RouterLink>
  </section>
